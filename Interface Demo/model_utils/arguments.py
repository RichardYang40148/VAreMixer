...
class ArgParser(object):
    def __init__(self):
        ...
        parser.add_argument('--id', default='model',
        ...
        parser.add_argument('--stride_frames', default=25, type=int,
        ...
        parser.add_argument('--audLen', default=262140, type=int,
                            help='sound length')
        ...
        parser.add_argument('--stft_hop', default=512, type=int,
        ...
        parser.add_argument('--eval_image', default=1, type=int,
                            help="whether to use image for evalutation")
        parser.add_argument('--inference', default=0,type=int,
                            help="inference")
        # parser.add_argument('--inference_image', default='./data/frames/accordion_0.jpg',
        #                     help="set specific image input for inference")
        # Misc arguments
        parser.add_argument('--seed', default=1234, type=int,
                            help='manual seed')
        parser.add_argument('--ckpt', default='./model_utils/ckpt',
